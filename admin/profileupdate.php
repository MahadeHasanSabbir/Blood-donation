<?php
	...
	if(isset($_SESSION['id'])){
		...
		$sqlquery1 = "SELECT * FROM tbdonor WHERE tbdonor.id = '$_GET[key]'";
		$sqlquery2 = "SELECT * FROM donorlog WHERE donorlog.id = '$_GET[key]'";
			...
			<body>
				...
				<script>
					...
					function validate(){
						...
						var idvalue = document.getElementById('did').value;
						...
						if(!namepattern.test(namevalue)){
							...
							alert(namevalue + " information will update!\nClick ok to proceed");
						}
				</script>
			</body>
		</html>
